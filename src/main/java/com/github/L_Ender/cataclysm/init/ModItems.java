...
public class ModItems {
    ...
    public static final RegistryObject<BlockItem> END_STONE_TELEPORT_TRAP_BRICKS = ITEMS.register("end_stone_teleport_trap_bricks",
            () -> new BlockItem(ModBlocks.END_STONE_TELEPORT_TRAP_BRICKS.get(), new Item.Properties().tab(ModGroup.BLOCK)));
    ...
    public static final RegistryObject<BlockItem> POLISHED_AZURE_SEASTONE_STAIRS = ITEMS.register("polished_azure_seastone_stairs",
            () -> new BlockItem(ModBlocks.POLISHED_AZURE_SEASTONE_STAIRS.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> POLISHED_AZURE_SEASTONE_WALL = ITEMS.register("polished_azure_seastone_wall",
            () -> new BlockItem(ModBlocks.POLISHED_AZURE_SEASTONE_WALL.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> AZURE_SEASTONE_PILLAR = ITEMS.register("azure_seastone_pillar",
            () -> new BlockItem(ModBlocks.AZURE_SEASTONE_PILLAR.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> AZURE_SEASTONE_PILLAR_WALL = ITEMS.register("azure_seastone_pillar_wall",
            () -> new BlockItem(ModBlocks.AZURE_SEASTONE_PILLAR_WALL.get(), new Item.Properties().tab(ModGroup.BLOCK)));
    ...
    public static final RegistryObject<BlockItem> CHISELED_AZURE_SEASTONE_PILLAR = ITEMS.register("chiseled_azure_seastone_pillar",
            () -> new BlockItem(ModBlocks.CHISELED_AZURE_SEASTONE_PILLAR.get(), new Item.Properties().tab(ModGroup.BLOCK)));
    ...
    public static final RegistryObject<BlockItem> CHISELED_AZURE_SEASTONE_PILLAR_WALL = ITEMS.register("chiseled_azure_seastone_pillar_wall",
            () -> new BlockItem(ModBlocks.CHISELED_AZURE_SEASTONE_PILLAR_WALL.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> FROSTED_STONE_BRICKS = ITEMS.register("frosted_stone_bricks",
            () -> new BlockItem(ModBlocks.FROSTED_STONE_BRICKS.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> FROSTED_STONE_BRICK_SLAB = ITEMS.register("frosted_stone_brick_slab",
            () -> new BlockItem(ModBlocks.FROSTED_STONE_BRICK_SLAB.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> FROSTED_STONE_BRICK_STAIRS = ITEMS.register("frosted_stone_brick_stairs",
            () -> new BlockItem(ModBlocks.FROSTED_STONE_BRICK_STAIRS.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> FROSTED_STONE_BRICK_WALL = ITEMS.register("frosted_stone_brick_wall",
            () -> new BlockItem(ModBlocks.FROSTED_STONE_BRICK_WALL.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> BLACK_STEEL_BLOCK = ITEMS.register("black_steel_block",
            () -> new BlockItem(ModBlocks.BLACK_STEEL_BLOCK.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> BLACK_STEEL_FENCE = ITEMS.register("black_steel_fence",
            () -> new BlockItem(ModBlocks.BLACK_STEEL_FENCE.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<BlockItem> BLACK_STEEL_WALL = ITEMS.register("black_steel_wall",
            () -> new BlockItem(ModBlocks.BLACK_STEEL_WALL.get(), new Item.Properties().tab(ModGroup.BLOCK)));


    public static final RegistryObject<BlockItem> POINTED_ICICLE = ITEMS.register("pointed_icicle",
            () -> new BlockItem(ModBlocks.POINTED_ICICLE.get(), new Item.Properties().tab(ModGroup.BLOCK)));

    public static final RegistryObject<Item> WITHERITE_INGOT = ITEMS.register("witherite_ingot",
            () -> new Item(new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> ENDERITE_INGOT = ITEMS.register("enderite_ingot",
            () -> new ItemInventoryOnly(new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> ANCIENT_METAL_INGOT = ITEMS.register("ancient_metal_ingot",
            () -> new Item(new Item.Properties().tab(ModGroup.ITEM).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> BLACK_STEEL_INGOT = ITEMS.register("black_steel_ingot",
            () -> new Item(new Item.Properties().tab(ModGroup.ITEM)));
    ...
    public static final RegistryObject<Item> CORAL_SPEAR = ITEMS.register("coral_spear",
            () -> new Coral_Spear((new Item.Properties().tab(ModGroup.ITEM)).durability(110)));

    public static final RegistryObject<Item> CORAL_BARDICHE = ITEMS.register("coral_bardiche",
            () -> new Coral_Bardiche((new Item.Properties().tab(ModGroup.ITEM)).durability(160)));

    public static final RegistryObject<Item> ATHAME = ITEMS.register("athame",
            () -> new Athame((new Item.Properties().tab(ModGroup.ITEM)).durability(250)));

    public static final RegistryObject<Item> KHOPESH = ITEMS.register("khopesh",
            () -> new Khopesh(Tooltier.ANCIENT_METAL, new Item.Properties().tab(ModGroup.ITEM)));

    public static final RegistryObject<Item> BLACK_STEEL_SWORD = ITEMS.register("black_steel_sword",
            () -> new SwordItem(Tooltier.BLACK_STEEL, 3, -2.4F, new Item.Properties().tab(ModGroup.ITEM)));
    
    public static final RegistryObject<Item> BLACK_STEEL_SHOVEL = ITEMS.register("black_steel_shovel",
            () -> new ShovelItem(Tooltier.BLACK_STEEL, 1.5F, -3.0F, new Item.Properties().tab(ModGroup.ITEM)));

    public static final RegistryObject<Item> BLACK_STEEL_PICKAXE = ITEMS.register("black_steel_pickaxe",
            () -> new PickaxeItem(Tooltier.BLACK_STEEL, 1, -2.8F, new Item.Properties().tab(ModGroup.ITEM)));

    public static final RegistryObject<Item> BLACK_STEEL_AXE = ITEMS.register("black_steel_axe",
            () -> new AxeItem(Tooltier.BLACK_STEEL, 6.0F, -3.1F, new Item.Properties().tab(ModGroup.ITEM)));
    
    public static final RegistryObject<Item> BLACK_STEEL_HOE = ITEMS.register("black_steel_hoe",
            () -> new HoeItem(Tooltier.BLACK_STEEL, -2, -1.0F, new Item.Properties().tab(ModGroup.ITEM)));

    public static final RegistryObject<Item> BLACK_STEEL_TARGE = ITEMS.register("black_steel_targe",
            () -> new Black_Steel_Targe(new Item.Properties().tab(ModGroup.ITEM).durability(840)));

    public static final RegistryObject<Item> BULWARK_OF_THE_FLAME = ITEMS.register("bulwark_of_the_flame",
            () -> new Bulwark_of_the_flame(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));

    public static final RegistryObject<Item> GAUNTLET_OF_GUARD = ITEMS.register("gauntlet_of_guard",
            () -> new Gauntlet_of_Guard(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));

    public static final RegistryObject<Item> GAUNTLET_OF_BULWARK = ITEMS.register("gauntlet_of_bulwark",
            () -> new Gauntlet_of_Bulwark(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    
    public static final RegistryObject<Item> GAUNTLET_OF_MAELSTROM = ITEMS.register("gauntlet_of_maelstrom",
            () -> new Gauntlet_of_Maelstrom(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));

    public static final RegistryObject<Item> THE_INCINERATOR = ITEMS.register("the_incinerator",
            () -> new The_Incinerator(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    
    public static final RegistryObject<Item> BLAZING_GRIPS = ITEMS.register("blazing_grips",
            () -> new Blazing_Grips(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    
    public static final RegistryObject<Item> CURSED_BOW = ITEMS.register("cursed_bow",
            () -> new Cursed_bow(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    
    public static final RegistryObject<Item> WRATH_OF_THE_DESERT = ITEMS.register("wrath_of_the_desert",
            () -> new Wrath_of_the_desert(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    
    public static final RegistryObject<Item> SOUL_RENDER = ITEMS.register("soul_render",
            () -> new Soul_Render(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> THE_ANNIHILATOR = ITEMS.register("the_annihilator",
            () -> new The_Annihilator(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).fireResistant().rarity(Rarity.EPIC)));
    
    public static final RegistryObject<Item> THE_IMMOLATOR = ITEMS.register("the_immolator",
            () -> new The_Immolator(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> MEAT_SHREDDER = ITEMS.register("meat_shredder",
            () -> new Meat_Shredder(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> LASER_GATLING = ITEMS.register("laser_gatling",
            () -> new Laser_Gatling(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).fireResistant().durability(50).rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> WITHER_ASSULT_SHOULDER_WEAPON = ITEMS.register("wither_assault_shoulder_weapon",
            () -> new Wither_Assault_SHoulder_Weapon(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));

    public static final RegistryObject<Item> VOID_ASSULT_SHOULDER_WEAPON = ITEMS.register("void_assault_shoulder_weapon",
            () -> new Void_Assault_SHoulder_Weapon(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));

    public static final RegistryObject<Item> VOID_FORGE = ITEMS.register("void_forge",
            () -> new void_forge(Tooltier.MONSTROSITY, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> TIDAL_CLAWS = ITEMS.register("tidal_claws",
            () -> new Tidal_Claws(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    ...
    public static final RegistryObject<Item> INFERNAL_FORGE = ITEMS.register("infernal_forge",
            () -> new infernal_forge(Tooltier.MONSTROSITY, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> SANDSTORM_IN_A_BOTTLE = ITEMS.register("sandstorm_in_a_bottle",
            () -> new Sandstorm_In_A_Bottle(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    
    public static final RegistryObject<Item> ANCIENT_SPEAR = ITEMS.register("ancient_spear",
            () -> new Ancient_Spear(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant().durability(1800)));

    public static final RegistryObject<Item> STICKY_GLOVES = ITEMS.register("sticky_gloves",
            () -> new Sticky_Gloves(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1)));

    public static final RegistryObject<Item> REMNANT_SKULL = ITEMS.register("remnant_skull",
            () -> new Remnant_Skull(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));

    public static final RegistryObject<Item> NETHERITE_EFFIGY = ITEMS.register("netherite_effigy",
            () -> new Netherite_Effigy(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));

    public static final RegistryObject<Item> VOID_SCATTER_ARROW = ITEMS.register("void_scatter_arrow",
            () -> new Void_Scatter_Arrow_Item(new Item.Properties().tab(ModGroup.ITEM).fireResistant()));
    ...
    public static final RegistryObject<Item> VOID_JAW = ITEMS.register("void_jaw",
            () -> new Item(new Item.Properties().tab(ModGroup.ITEM).fireResistant()));

    public static final RegistryObject<Item> VOID_CORE = ITEMS.register("void_core",
            () -> new void_core(new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).fireResistant().rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> ABYSSAL_SACRIFICE = ITEMS.register("abyssal_sacrifice",
            () -> new Item(new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.RARE)));
    ...
    public static final RegistryObject<Item> BONE_REPTILE_CHESTPLATE = ITEMS.register("bone_reptile_chestplate",
            () -> new Bone_Reptile_Armor(Armortier.BONE_REPTILE, EquipmentSlot.CHEST, new Item.Properties().tab(ModGroup.ITEM)));

    public static final RegistryObject<Item> IGNITIUM_HELMET = ITEMS.register("ignitium_helmet",
            () -> new Ignitium_Armor(Armortier.IGNITIUM, EquipmentSlot.HEAD, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> IGNITIUM_CHESTPLATE = ITEMS.register("ignitium_chestplate",
            () -> new Ignitium_Armor(Armortier.IGNITIUM, EquipmentSlot.CHEST, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> IGNITIUM_ELYTRA_CHESTPLATE = ITEMS.register("ignitium_elytra_chestplate",
            () -> new Ignitium_Elytra_ChestPlate(new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC), Armortier.IGNITIUM));

    public static final RegistryObject<Item> IGNITIUM_LEGGINGS = ITEMS.register("ignitium_leggings",
            () -> new Ignitium_Armor(Armortier.IGNITIUM, EquipmentSlot.LEGS, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> IGNITIUM_BOOTS = ITEMS.register("ignitium_boots",
            () -> new Ignitium_Armor(Armortier.IGNITIUM, EquipmentSlot.FEET, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));
    
    public static final RegistryObject<Item> CURSIUM_HELMET = ITEMS.register("cursium_helmet",
            () -> new Cursium_Armor(Armortier.CURSIUM, EquipmentSlot.HEAD, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> CURSIUM_CHESTPLATE = ITEMS.register("cursium_chestplate",
            () -> new Cursium_Armor(Armortier.CURSIUM, EquipmentSlot.CHEST, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> CURSIUM_LEGGINGS = ITEMS.register("cursium_leggings",
            () -> new Cursium_Armor(Armortier.CURSIUM, EquipmentSlot.LEGS, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> CURSIUM_BOOTS = ITEMS.register("cursium_boots",
            () -> new Cursium_Armor(Armortier.CURSIUM, EquipmentSlot.FEET, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));
    ...
    public static final RegistryObject<Item> MONSTROUS_HELM = ITEMS.register("monstrous_helm",
            () -> new Monstrous_Helm(ArmorMaterials.NETHERITE, EquipmentSlot.HEAD, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> BLOOM_STONE_PAULDRONS = ITEMS.register("bloom_stone_pauldrons",
            () -> new Bloom_Stone_Pauldrons(Armortier.CRAB, EquipmentSlot.CHEST, new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> DYING_EMBER = ITEMS.register("dying_ember",
            () -> new Item(new Item.Properties().tab(ModGroup.ITEM).fireResistant().rarity(Rarity.UNCOMMON)));

    public static final RegistryObject<Item> MUSIC_DISC_NETHERITE_MONSTROSITY = ITEMS.register("music_disc_netherite_monstrosity",
            () -> new RecordItem(14, ModSounds.MONSTROSITY_MUSIC,new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 289 * 20));

    public static final RegistryObject<Item> MUSIC_DISC_ENDER_GUARDIAN = ITEMS.register("music_disc_ender_guardian",
            () -> new RecordItem(14, ModSounds.ENDERGUARDIAN_MUSIC,new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 226 * 20));

    public static final RegistryObject<Item> MUSIC_DISC_IGNIS = ITEMS.register("music_disc_ignis",
            () -> new RecordItem(14, ModSounds.IGNIS_MUSIC,new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 153 * 20));

    public static final RegistryObject<Item> MUSIC_DISC_THE_HARBINGER = ITEMS.register("music_disc_the_harbinger",
            () -> new RecordItem(14, ModSounds.HARBINGER_MUSIC,new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 144 * 20));

    public static final RegistryObject<Item> MUSIC_DISC_THE_LEVIATHAN = ITEMS.register("music_disc_the_leviathan",
            () -> new RecordItem(14, ModSounds.LEVIATHAN_MUSIC,new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 291 * 20));

    public static final RegistryObject<Item> MUSIC_DISC_ANCIENT_REMNANT = ITEMS.register("music_disc_ancient_remnant",
            () -> new RecordItem(14, ModSounds.REMNANT_MUSIC,new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 212 * 20));
    
    public static final RegistryObject<Item> MUSIC_DISC_MALEDICTUS = ITEMS.register("music_disc_maledictus",
            () -> new RecordItem(14, ModSounds.MALEDICTUS_MUSIC_DISC,new Item.Properties().tab(ModGroup.ITEM).stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 201 * 20));

    public static final RegistryObject<Item> MECH_EYE = ITEMS.register("mech_eye",
            () -> new MechEyeItem(new Item.Properties().tab(ModGroup.ITEM).fireResistant()));

    public static final RegistryObject<Item> FLAME_EYE = ITEMS.register("flame_eye",
            () -> new FlameEyeItem(new Item.Properties().tab(ModGroup.ITEM).fireResistant()));

    public static final RegistryObject<Item> VOID_EYE = ITEMS.register("void_eye",
            () -> new VoidEyeItem(new Item.Properties().tab(ModGroup.ITEM).fireResistant()));

    public static final RegistryObject<Item> MONSTROUS_EYE = ITEMS.register("monstrous_eye",
            () -> new MonstrousEyeItem(new Item.Properties().tab(ModGroup.ITEM).fireResistant()));

    public static final RegistryObject<Item> ABYSS_EYE = ITEMS.register("abyss_eye",
            () -> new AbyssEyeItem(new Item.Properties().tab(ModGroup.ITEM).fireResistant()));

    public static final RegistryObject<Item> DESERT_EYE = ITEMS.register("desert_eye",
            () -> new DesertEyeItem(new Item.Properties().tab(ModGroup.ITEM).fireResistant()));
    
    public static final RegistryObject<Item> CURSED_EYE = ITEMS.register("cursed_eye",
            () -> new CursedEyeItem(new Item.Properties().tab(ModGroup.ITEM).fireResistant()));

    public static final RegistryObject<Item> LIONFISH = ITEMS.register("lionfish",
            () -> new Item(new Item.Properties().tab(ModGroup.ITEM).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.1F)
    ...
    public static final RegistryObject<Item> AMETHYST_CRAB_MEAT = ITEMS.register("amethyst_crab_meat",
            () -> new Item(new Item.Properties().tab(ModGroup.ITEM).food(new FoodProperties.Builder().nutrition(6).saturationMod(1.2F)
    ...
    public static final RegistryObject<Item> BLESSED_AMETHYST_CRAB_MEAT = ITEMS.register("blessed_amethyst_crab_meat",
            () -> new Blessed_Amethyst_Crab_Meat(new Item.Properties().tab(ModGroup.ITEM).rarity(Rarity.EPIC).food(new FoodProperties.Builder().nutrition(6).saturationMod(1.2F)
    ...
    public static final RegistryObject<Item> BACON = ITEMS.register("bacon",
            () -> new Item(new Item.Properties().tab(ModGroup.ITEM).food(new FoodProperties.Builder().nutrition(3).saturationMod(0.6F).build())));
    ...
    public static final RegistryObject<Item> THE_BABY_LEVIATHAN_BUCKET = ITEMS.register("the_baby_leviathan_bucket",
            () -> new ModFishBucket(ModEntities.THE_BABY_LEVIATHAN, Fluids.WATER, new Item.Properties().tab(ModGroup.ITEM).fireResistant()));

    public static final RegistryObject<Item> MODERN_REMNANT_BUCKET = ITEMS.register("modern_remnant_bucket",
            () -> new ModernRemantBucket(ModEntities.MODERN_REMNANT, Fluids.EMPTY, new Item.Properties().tab(ModGroup.ITEM).fireResistant()));
    ...
    public static final RegistryObject<SpawnEggItem> NETHERITE_MONSTROSITY_SPAWN_EGG = ITEMS.register("netherite_monstrosity_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.NETHERITE_MONSTROSITY, 0x4d494d, 0xf48522, new Item.Properties().tab(ModGroup.ITEM)));
